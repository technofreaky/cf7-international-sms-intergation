...
class CF7_International_SMS_Admin_Notices {
    ...
    private function __construct() {
        self::$instance = null;
        $this->noticesArrayName = CF7_ISMS_DB.'AdminNotices';
        $this->REQUESTID = CF7_ISMS_DB.'MSG';       
        $this->notices = array();
        $this->loadNotices();
     ...
     */
    public function addNotice(CF7_International_SMS_Admin_Notice $notice) {
        $this->notices[] = $notice;
        $this->storeNotices();
    }
     ...
     * @param CF7_International_SMS_Admin_Notice $notice
     * @return bool 
     */
    private function isTimeToDisplay(CF7_International_SMS_Admin_Notice $notice) {
 ...
 */
abstract class CF7_International_SMS_Admin_Notice {
    protected $content;
    protected $type;
    protected $screen;
    protected $id;
    ...
    public function getContentFormated($wrapInParTag = true) {
        ...
        $before = '<div id="cf7_isms_notice_'.$this->id.'"  class="' .$class. '">';
     ...
     * @return \CF7_International_SMS_Admin_Notice
     */
 ...
 * Type of notices
 */
class CF7_International_SMS_Admin_Error_Notice extends CF7_International_SMS_Admin_Notice { protected $type = 'error'; }
class CF7_International_SMS_Admin_Updated_Notice extends CF7_International_SMS_Admin_Notice { protected $type = 'updated'; }
class CF7_International_SMS_Admin_UpdateNag_Notice extends CF7_International_SMS_Admin_Notice { protected $type = 'update-nag'; }
 

/**
 * Hook action to admin init
 */
if(!has_action('init', array('CF7_International_SMS_Admin_Notices', 'getInstance'))){
    add_action('init', array('CF7_International_SMS_Admin_Notices', 'getInstance'));
}