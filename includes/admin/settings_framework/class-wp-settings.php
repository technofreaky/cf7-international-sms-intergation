 ...
 * @author keesiemeijer
 */
if ( !class_exists( 'CF7_International_SMS_WP_Settings' ) ) {
	class CF7_International_SMS_WP_Settings {
		...
		public function init( $pages, $page_hook = '' ) {
			...
			if ( !class_exists( 'CF7_International_SMS_Settings_WP_Fields' ) ) {
				$this->debug  .= "Error: class CF7_International_SMS_Settings_WP_Fields doesn't exist<br/>";
			}
			...
			$this->fields = new CF7_International_SMS_Settings_WP_Fields( get_settings_errors() );
        ...
        function do_settings_sections( $page ) {
            ...
            if($section_count > 1){
                echo '<ul class="subsubsub cf7_isms_settings_submenu">';
            ...
            foreach ( (array) $wp_settings_sections[$page] as $section ) {
                if($section_count > 1){ echo '<div id="settings_'.$section['id'].'" class="hidden cf7_isms_settings_content">'; }
                    if ( $section['title'] )
